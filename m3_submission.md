...
<tr><td> <em>Generated: </em> 10/4/2023 10:44:30 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT114-005-F23/it114-number-guesser/grade/maa" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmaa%2F2023-10-05T02.26.25image.png.webp?alt=media&token=c154f482-9c76-42c0-9dc4-01e6fa6c84a9"/></td></tr>
<tr><td> <em>Caption:</em> <p>I am showing the code that is specific to the implemented feature.<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmaa%2F2023-10-05T02.28.28image.png.webp?alt=media&token=d321c725-b232-4a26-8170-dbf35ef849c7"/></td></tr>
<tr><td> <em>Caption:</em> <p>I am showing the code that is specific to the working implemented feature,<br>as well as the output that is shown on the terminal after running<br>the program.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain the logic behind your implementation</td></tr>
<tr><td> <em>Response:</em> <div>Implementation 1 involves checking whether the player's guess is higher or lower than<br>the correct number. If the guess is incorrect, the code evaluates whether the<br>guess is higher or lower than the correct number using the comparison 'guess<br>&lt; number'. If the guess is lower than the correct number, it displays<br>"Lower"; if the guess is higher than the correct number, it displays "Higher."<br>This feature helps the player by providing a hint for their next guess,<br>enhancing the gaming experience and assisting them in making more informed choices during<br>the game.</div><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td> <em>Sub-Task 1: </em> Two Screenshots: Add a screenshot demonstrating the feature during runtime; Add a screenshot (or so) of the snippets of code that implement the feature</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmaa%2F2023-10-05T02.36.17image.png.webp?alt=media&token=05385038-c2da-48a6-9895-abf88a8df231"/></td></tr>
<tr><td> <em>Caption:</em> <p>I am showing the code that is specific to the implemented feature.<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmaa%2F2023-10-05T02.37.59Screenshot%202023-10-04%20223610.png.webp?alt=media&token=7cce064d-4719-4ed4-a030-8be37a92ebea"/></td></tr>
<tr><td> <em>Caption:</em> <p>I am showing the code that is specific to the working implemented feature,<br>as well as the output that is shown on the terminal after running<br>the program.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain the logic behind your implementation</td></tr>
